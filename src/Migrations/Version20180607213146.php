 ...
 */
class Version20180607213146 extends AbstractMigration
{
    public function up(Schema $schema)
    {
        ...
        $this->addSql('ALTER TABLE transaction_log ADD user_id INT NOT NULL');
    ...
    public function down(Schema $schema)
    {
        ...
        $this->addSql('ALTER TABLE transaction_log DROP user_id');
    }
}
