 ...
 */
class Version20180505204513 extends AbstractMigration
{
    public function up(Schema $schema)
    {
        ...
        $this->addSql('ALTER TABLE transaction_log CHANGE message message VARCHAR(100) DEFAULT NULL');
    ...
    public function down(Schema $schema)
    {
        ...
        $this->addSql('ALTER TABLE transaction_log CHANGE message message VARCHAR(100) NOT NULL COLLATE utf8mb4_unicode_ci');
    }
}
